...
function Filter() {
    ...
    const { product, mode, searchkey, setSearchkey, filterType, setFilterType, filterPrice, setFilterPrice } = context

    return (
        <div>
           <div className=' container mx-auto px-4 mt-5 '>
                <div className="p-5 rounded-lg bg-gray-100 drop-shadow-lg"
                    style={{
