                ...
                <div className="tab container mx-auto ">
                    <Tabs defaultIndex={0} className=" " >
                        <TabList className="md:flex md:space-x-8 bg-  grid grid-cols-2 text-center gap-4   md:justify-center mb-10 ">
                            <Tab>
                                <button type="button" className="font-medium border-b-2 border-purple-500 text-purple-500 rounded-lg text-xl  px-5 py-1.5 text-center bg-[#605d5d12] ">
                                    <div className="flex gap-2 items-center">
                                        <MdOutlineProductionQuantityLimits />Products</div> </button>
                            </Tab>
                            <Tab>
                                <button type="button" className="font-medium border-b-2 border-pink-500 bg-[#605d5d12] text-pink-500  rounded-lg text-xl    px-5 py-1.5 text-center ">
                                    <div className="flex gap-2 items-center">
                            ...
                            <Tab>
                                <button type="button" className="font-medium border-b-2 border-green-500 bg-[#605d5d12] text-green-500 rounded-lg text-xl    px-5 py-1.5 text-center ">
                                    <div className="flex gap-2 items-center">
                                        <FaUser /> Users
                                    </div>
                                </button>
                            ...
                            <div className='  px-4 md:px-0 mb-16'>
                                ...
                                <div className=" flex justify-end">
                                    <Link to={'/addproduct'}>
                                        <button
                                            type="button"
                                            className="focus:outline-none text-white bg-pink-600  border hover:bg-pink-700 outline-0 font-medium rounded-lg text-sm px-5 py-2.5 mb-2" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} > <div className="flex gap-2 items-center">
                                ...
                                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    ...
                                    <tbody>
                                        {orders.map((allorder, index) => (
                                            allorder.cartItems.map((item, innerIndex) => {
                                                const { title, description, category, imageUrl, price } = item;
                                                console.log(item);
                                                return (
                                                    <tr key={innerIndex} className={`bg-gray-50 border-b ${mode === 'dark' ? 'dark:border-gray-700' : ''}`} style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '' }}>
                                                        <td className="px-6 py-4 text-black" style={{ color: mode === 'dark' ? 'white' : '' }}>
                                                            {innerIndex + 1}.
                                                        </td>
                                                        <td className="px-6 py-4 text-black" style={{ color: mode === 'dark' ? 'white' : '' }}>
